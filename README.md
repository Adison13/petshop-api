...
1. Clone o repositorio: git clone https://github.com/Adison13/petshop-api.git

2. Crie o banco de dados no PostgreSQL: CREATE DATABASE petshopdb;

3. Configure o arquivo src/main/resources/application.properties com suas credenciais do banco
